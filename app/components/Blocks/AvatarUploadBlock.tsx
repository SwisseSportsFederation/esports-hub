...
type AvatarUploadBlockPropTypes = {
  entity: EntityType,
  entityId: number,
  imageId: StringOrNull
}

const AvatarUploadBlock = ({ entity, entityId, imageId }: AvatarUploadBlockPropTypes) => {
  ...
  return <>
    ...
    <Modal isOpen={deleteImageOpen} handleClose={() => setDeleteImageOpen(false)}>
      ...
      <fetcher.Form action={'/admin/api/avatar'} encType="multipart/form-data" method="delete"
    ...
    <Modal isOpen={uploadOpen} handleClose={() => setUploadOpen(false)}>
      <div className="flex flex-col gap-4 w-full">
        ...
        <fetcher.Form action={'/admin/api/avatar'} method="put" onSubmit={() => {
          setUploadOpen(false);
...
export default AvatarUploadBlock;
